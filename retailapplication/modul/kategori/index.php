...
<table id="myTable" class="table table-striped table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><span class="badge <?= $row_kategori['status'] ==1 ? 'text-bg-success' : 'text-bg-danger'; ?>"><?= $row_kategori['status'] ==1 ? 'Aktif' : 'Tidak Aktif'; ?>
                </span>
            </td>
            <td>
                <!-- Icon Edit -->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="modul/kategori/proses.php?aksi=edit&id=<?= $row_kategori['id_kategori']; ?>" method="post">
                                <div class="modal-body">
                                    <div class="mb-3"> 
                                        <label class="from-label"  for="namakategori">Nama Kategori</label>
