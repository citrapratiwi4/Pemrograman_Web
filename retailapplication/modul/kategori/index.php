    ...
    <tbody>
        ...
        while($row_kategori = $result_kategori->fetch_assoc()){
            ...
            <tr>
                ...
                <td><span class="badge <?=$row_kategori['status']== 1?'text-bg-success':'text-bg-danger';?>"><?=$row_kategori['status'] == 1?'Aktif':'Tidak Aktif'; ?></span>
            </td>
                <td>
                    <a href=""  data-bs-toggle="modal"  data-bs-target="#modalEdit<?=$row_kategori['id_kategori'];?>" class="text-warning"><i class="bi bi-pencil-square"></i></a>
                    ...
                    <div class="modal fade"  id="modalHapus<?=$row_kategori['id_kategori'];?>"  tabindex="-1"  aria-labelledby="exampleModalLabel"  aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">Apakah anda yakin akan menghapus data kategori <?=$row_kategori['nama_kategori'];?>?</div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
